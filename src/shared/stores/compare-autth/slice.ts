...
export const compareAuthSlice = createSlice({
  name: "compareAuth",
  initialState,
  reducers: {
...
export const selectCompareAuth = (state: RootState) => state.compareAuth;
export const { addGoods, removeGoods, updateGoods } = compareAuthSlice.actions;

export default compareAuthSlice.reducer;
