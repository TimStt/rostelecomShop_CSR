...
export const favoritesAuthSlice = createSlice({
  name: "favoritesAuth",
  initialState,
  reducers: {
...
export const selectFavoritesAuth = (state: RootState) => state.favoritesAuth;
// export const { addGoods, removeGoods, updateGoods } =
//   favoritesAuthSlice.actions;

export default favoritesAuthSlice.reducer;
